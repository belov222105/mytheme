...
<div class="container">
  <div class="row">
    ...
    <div class="single-post-block block-center bg-white margin-top-30 margin-bottom-20 padding-right-20 padding-left-20 padding-top-20 padding-bottom-20 border-radius-3 single-post-shadow" style="<?php echo 'margin-top: ' . $avadosFramework['container_margin_top'] ?>%">
